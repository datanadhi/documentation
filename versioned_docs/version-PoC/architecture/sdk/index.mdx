...
- For the full schema and examples, check out [Log Config details](/docs/architecture/sdk/log-config).
...
- For a detailed breakdown of all the fields, see [Log Structure](/docs/architecture/sdk/log-structure)
